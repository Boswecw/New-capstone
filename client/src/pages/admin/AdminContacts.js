...
const AdminContacts = () => {
  ...
  const handleStatusChange = async (contact, newStatus) => {
    try {
      await api.put(`/admin/contacts/${contact._id}/status`, { status: newStatus });
  ...
  return (
    <>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1><i className="fas fa-envelope me-2"></i>Contact Management</h1>
      </div>
        ...
        <Card.Body>
            ...
            <Modal show={showResponseModal} onHide={() => setShowResponseModal(false)} centered>
              ...
              <Modal.Footer>
                ...
                <Button variant="primary" onClick={handleSendResponse} disabled={!responseMessage.trim()}>
                  Send Response
                </Button>
              </Modal.Footer>
            </Modal>
