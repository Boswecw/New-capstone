// // client/src/components/ProductCard.js - WITH ENHANCED CSS
...
// import './EnhancedCards.css'; // ✅ Import the enhanced CSS styles
...
//   return (
//     <Card 
//       className={`enhancedCard h-100 ${className}`} 
//       data-testid={`product-card-${safeProduct._id}`}
//     >
//       {/* Enhanced Image Container with Dynamic Sizing */}
//       <div className={`productImgContainer ${containerType}`}>
//         <SafeImage
//           item={safeProduct}
...
//         {/* Enhanced Header with name and price */}
//         <div className="d-flex justify-content-between align-items-start mb-2">
//           <h5 className="enhancedCardTitle mb-0 flex-grow-1">
//             {safeProduct.name}
//           </h5>
//           {safeProduct.price > 0 && (
...
//             <Badge bg="secondary" className="enhancedBadge">
//               {safeProduct.brand}
//             </Badge>
//           )}
//           {!safeProduct.inStock && (
...
//                 size="sm"
//                 className="enhancedButton w-100"
//               >
...
// client/src/components/ProductCard.js - FIXED VERSION (No CSS modules)
